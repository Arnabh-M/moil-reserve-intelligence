  ...
  return (
    <header className="flex h-16 shrink-0 items-center justify-between border-b border-border bg-white px-6">
      ...
      <div className="flex items-center gap-5">
        <div className="hidden sm:flex items-center gap-2 rounded-sm border border-border bg-bg px-3 py-1.5 text-xs font-medium text-slate-600">
        ...
        >
          ...
          <span className="absolute top-1.5 right-1.5 h-1.5 w-1.5 rounded-full bg-orange" />
        </button>
