...
function RoutedShell() { const location = useLocation(); return <ErrorBoundary resetKey={location.pathname}><Shell><Routes><Route path="/" element={<Dashboard />} /><Route path="/site/:id" element={<SitePage />} /><Route path="/map" element={<MapPage />} /><Route path="/reports" element={<ReportsPage />} /><Route path="/simulator" element={<SimulatorPage />} /><Route path="/field-intake" element={<FieldIntakePage />} /><Route path="/settings" element={<SettingsPage />} /><Route path="/timeline" element={<Navigate to="/reports" replace />} /><Route path="/recommendations" element={<Navigate to="/reports" replace />} /><Route path="/data-input" element={<Navigate to="/field-intake" replace />} /><Route path="*" element={<NotFound />} /></Routes></Shell></ErrorBoundary>; }
