...
const equipment = [
  { id: 101, site_id: 1, site_name: 'Balaghat', name: 'Excavator BAL-1', equipment_type: 'Excavator', status: 'down', last_status_change: '2026-09-05T06:40:00Z', status_reason: 'Hydraulic pressure drift' },
  { id: 102, site_id: 1, site_name: 'Balaghat', name: 'Drill BAL-2', equipment_type: 'Drill', status: 'up', last_status_change: '2026-09-04T18:20:00Z', status_reason: 'Scheduled inspection complete' },
  { id: 103, site_id: 1, site_name: 'Balaghat', name: 'Conveyor BAL-3', equipment_type: 'Conveyor', status: 'up', last_status_change: '2026-09-04T12:10:00Z', status_reason: 'Normal operating state' },
  { id: 104, site_id: 1, site_name: 'Balaghat', name: 'Loader BAL-4', equipment_type: 'Loader', status: 'up', last_status_change: '2026-09-04T17:02:00Z', status_reason: 'Normal operating state' },
  { id: 105, site_id: 1, site_name: 'Balaghat', name: 'Compressor BAL-5', equipment_type: 'Compressor', status: 'up', last_status_change: '2026-09-04T15:30:00Z', status_reason: 'Normal operating state' },
  { id: 201, site_id: 2, site_name: 'Nagpur', name: 'Excavator NAG-1', equipment_type: 'Excavator', status: 'down', last_status_change: '2026-09-05T02:12:00Z', status_reason: 'Drive motor trip' },
  { id: 202, site_id: 2, site_name: 'Nagpur', name: 'Drill NAG-2', equipment_type: 'Drill', status: 'up', last_status_change: '2026-09-04T12:10:00Z', status_reason: 'Normal operating state' },
  { id: 203, site_id: 2, site_name: 'Nagpur', name: 'Conveyor NAG-3', equipment_type: 'Conveyor', status: 'up', last_status_change: '2026-09-04T16:04:00Z', status_reason: 'Normal operating state' },
  { id: 204, site_id: 2, site_name: 'Nagpur', name: 'Loader NAG-4', equipment_type: 'Loader', status: 'up', last_status_change: '2026-09-04T11:24:00Z', status_reason: 'Normal operating state' },
  { id: 205, site_id: 2, site_name: 'Nagpur', name: 'Compressor NAG-5', equipment_type: 'Compressor', status: 'up', last_status_change: '2026-09-04T10:08:00Z', status_reason: 'Normal operating state' },
  { id: 301, site_id: 3, site_name: 'Bhandara', name: 'Excavator BHA-1', equipment_type: 'Excavator', status: 'up', last_status_change: '2026-09-04T17:02:00Z', status_reason: 'Normal operating state' },
  { id: 302, site_id: 3, site_name: 'Bhandara', name: 'Drill BHA-2', equipment_type: 'Drill', status: 'up', last_status_change: '2026-09-04T16:18:00Z', status_reason: 'Normal operating state' },
  { id: 303, site_id: 3, site_name: 'Bhandara', name: 'Conveyor BHA-3', equipment_type: 'Conveyor', status: 'up', last_status_change: '2026-09-04T14:32:00Z', status_reason: 'Normal operating state' },
  { id: 304, site_id: 3, site_name: 'Bhandara', name: 'Loader BHA-4', equipment_type: 'Loader', status: 'up', last_status_change: '2026-09-04T13:20:00Z', status_reason: 'Normal operating state' },
  { id: 305, site_id: 3, site_name: 'Bhandara', name: 'Compressor BHA-5', equipment_type: 'Compressor', status: 'up', last_status_change: '2026-09-04T12:44:00Z', status_reason: 'Normal operating state' },
];
...
const production = sites.flatMap((site, siteIndex) => Array.from({ length: 7 }, (_, i) => {
  ...
  return { id: site.id * 1000 + i + 1, site_id: site.id, date: `2026-09-${String(1 + i).padStart(2, '0')}`, actual_output: Math.round(target * (1 + variance / 100)), target_output: target, variance_pct: variance };
}));
...
export const mockData = {
  ...
  simulation,
  upload: { filename: 'sample_survey.pdf', text_extracted: true, deposit_count: 2, deposits: [{ deposit_id: 'BAL-D1', depth: 145.2, grade: 38.5, structure_type: 'fold_axis', belt_zone: 'Balaghat-Manganese Belt' }, { deposit_id: 'BAL-D2', depth: 176.4, grade: 30.0, structure_type: 'shear_contact', belt_zone: 'Balaghat-Manganese Belt' }], nodes_created: [{ id: 'oz_upload_bal_d1', label: 'BAL-D1', type: 'OreZone' }, { id: 'oz_upload_bal_d2', label: 'BAL-D2', type: 'OreZone' }], warnings: ['One appendix table was below extraction confidence and needs a manual check.'] },
  notes,
